  ...
  return (
    <section className="py-6 px-3 sm:px-6 max-w-7xl mx-auto" id="live-price-section">
      <div>
        ...
        {/* Title & Actions */}
        <div className="bg-white dark:bg-slate-900 rounded-2xl sm:rounded-3xl p-5 sm:p-8 border border-slate-200 dark:border-slate-800 shadow-xs mb-6 transition-colors">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
              <div className="flex items-center gap-2 mb-1.5 flex-wrap">
                <span className="inline-flex items-center gap-1.5 bg-blue-50 dark:bg-blue-950/70 text-blue-800 dark:text-blue-300 text-xs font-black px-2.5 py-1 rounded-lg border border-blue-200 dark:border-blue-800">
          ...
          <div className="mt-5 grid grid-cols-1 sm:grid-cols-12 gap-3 pt-4 border-t border-slate-100 dark:border-slate-800">
            <div className="sm:col-span-7 relative">
              ...
              <input
                ...
                className="w-full bg-slate-50 dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700 rounded-xl pr-10 pl-4 py-2.5 text-xs focus:bg-white dark:focus:bg-slate-800 focus:border-blue-500 focus:outline-none transition-colors font-medium text-slate-800 dark:text-slate-200"
              />
            </div>
            ...
            <div className="sm:col-span-5 flex items-center gap-2">
              ...
              <select
                ...
                className="w-full bg-slate-50 dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700 rounded-xl px-3 py-2.5 text-xs font-bold text-slate-800 dark:text-slate-200 focus:bg-white dark:focus:bg-slate-800 focus:border-blue-500 focus:outline-none transition-colors"
              >
        ...
        <div className="bg-white dark:bg-slate-900 rounded-2xl sm:rounded-3xl border border-slate-200 dark:border-slate-800 shadow-xs overflow-hidden transition-colors">
          <div className="overflow-x-auto">
            <table className="w-full text-right text-xs">
              <thead className="bg-slate-50 dark:bg-slate-800/80 text-slate-700 dark:text-slate-300 font-black border-b border-slate-200 dark:border-slate-800">
                <tr>
                    ...
                    >
                      ...
                      <td className="p-3.5 sm:p-4">
                        ...
                        >
                          <img 
                            src={product.image} 
                            alt={product.nameFa}
                            className="w-10 h-10 rounded-xl object-cover border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 shrink-0"
                          />
                          <div>
                      ...
                      <td className="p-3.5 sm:p-4 text-center">
                        <div className="inline-flex flex-col items-center gap-1">
                          ...
                          <span className="text-[10px] text-emerald-700 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-950/70 border border-emerald-200 dark:border-emerald-800 px-2 py-0.5 rounded-md font-bold flex items-center gap-1">
                      ...
                      <td className="p-3.5 sm:p-4 text-left">
                        <div className="font-black text-sm text-blue-700 dark:text-blue-400">
                      ...
                      <td className="p-3.5 sm:p-4 text-center">
                        {product.priceTrend === 'up' && (
                          <span className="inline-flex items-center gap-1 text-rose-600 dark:text-rose-400 bg-rose-50 dark:bg-rose-950/60 border border-rose-200 dark:border-rose-800 px-2 py-1 rounded-lg text-[10px] font-black">
                            <ArrowUpRight className="w-3 h-3" />
                            افزایشی
                          </span>
                        )}
                        {product.priceTrend === 'down' && (
                          <span className="inline-flex items-center gap-1 text-emerald-600 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-950/60 border border-emerald-200 dark:border-emerald-800 px-2 py-1 rounded-lg text-[10px] font-black">
                            <ArrowDownRight className="w-3 h-3" />
                            کاهشی
                          </span>
                        )}
                        {product.priceTrend === 'stable' && (
                          <span className="inline-flex items-center gap-1 text-slate-600 dark:text-slate-300 bg-slate-100 dark:bg-slate-800 px-2 py-1 rounded-lg text-[10px] font-bold">
                        ...
                        <div className="flex items-center justify-center gap-1.5 flex-wrap">
                          <div className="flex items-center bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg p-0.5">
                            <button
                              ...
                              className="w-6 h-6 rounded bg-white dark:bg-slate-700 text-slate-800 dark:text-white flex items-center justify-center font-bold text-xs hover:bg-blue-100 hover:text-blue-700"
                              title="افزایش"
                            >
                              +
                            </button>
                            <span className="w-6 text-center font-bold text-xs text-slate-800 dark:text-slate-200">
                              {formatNumberFa(qty)}
                            </span>
                            <button
                              onClick={() => setQty(product.id, qty - 1)}
                              className="w-6 h-6 rounded bg-white dark:bg-slate-700 text-slate-800 dark:text-white flex items-center justify-center font-bold text-xs hover:bg-slate-200 dark:hover:bg-slate-600"
                              title="کاهش"
                            >
                              -
                            </button>
                          ...
                          <button
                            ...
                            className="px-2 py-1.5 rounded-lg bg-slate-800 dark:bg-slate-700 hover:bg-slate-900 dark:hover:bg-slate-600 text-white font-black text-[11px] transition-colors shadow-2xs flex items-center gap-1"
