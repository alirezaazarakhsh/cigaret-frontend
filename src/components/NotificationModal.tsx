...
export const NotificationModal: React.FC<NotificationModalProps> = ({
  ...
  return (
    ...
    >
      <div 
        className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl w-full max-w-xl overflow-hidden shadow-2xl flex flex-col max-h-[85vh] sm:max-h-[90vh] transition-all"
      ...
      >
        ...
        <div className="bg-slate-50 dark:bg-slate-800/60 p-2.5 px-4 sm:px-5 border-b border-slate-200 dark:border-slate-800 flex items-center justify-between gap-2 flex-wrap shrink-0">
          ...
          {unreadCount > 0 && (
            <button
              ...
              className="text-[11px] text-blue-600 dark:text-blue-400 hover:underline font-bold flex items-center gap-1 py-1 px-2 rounded-lg hover:bg-blue-50 dark:hover:bg-blue-950/40 transition-colors"
            >
              ...
              <div
                ...
                className={`p-3.5 sm:p-4 rounded-2xl border transition-all cursor-pointer space-y-2 relative ${
                  !item.isRead
                    ...
                    : 'bg-white dark:bg-slate-900/90 border-slate-200 dark:border-slate-800/80 opacity-90 hover:opacity-100'
                }`}
              >
                {/* Header row inside card */}
                <div className="flex items-start justify-between gap-3">
                  <div className="flex items-center gap-2.5 min-w-0">
                    <div className="p-2 rounded-xl bg-white dark:bg-slate-800 shadow-2xs border border-slate-100 dark:border-slate-700/60 shrink-0">
                  ...
                  <span className="text-[10px] sm:text-[11px] text-slate-400 dark:text-slate-500 font-medium flex items-center gap-1 shrink-0 bg-slate-100 dark:bg-slate-800/80 px-2 py-1 rounded-lg">
                ...
                {/* Message Body */}
                <p className="text-xs text-slate-600 dark:text-slate-300 leading-relaxed pr-10 sm:pr-11">
                  {item.message}
                </p>
        ...
        {/* Modal Footer */}
        <div className="p-3 sm:p-4 bg-slate-50 dark:bg-slate-950 border-t border-slate-200 dark:border-slate-800 text-center text-[11px] text-slate-500 dark:text-slate-400 shrink-0">
