...
export const CIGARETTE_PRODUCTS: CigaretteProduct[] = [
  ...
  },
  {
    ...
    isPosOnly: true,
    tierDiscounts: [],
    description: 'قهوه اسپرسو دوبل عربیکا ۷۰٪ با کرمای عالی، سرو داغ و تازه ویژه مشتریان و مراجعه‌کنندگان حضوری فروشگاه.'
  },
  {
    ...
    isPosOnly: true,
    tierDiscounts: [],
    description: 'قوطی ۲۵۰ میلی‌لیتری ردبول اصلی خنک ویژه فروش حضوری در صندوق فروشگاه.'
  },
  {
