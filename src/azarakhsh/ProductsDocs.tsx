...
### 💵 ۲. محاسبه دوگانه قیمت (باکس و کارتن) و فیلتر بازه قیمت (Min to Max Price Filtering):
* **پیش‌فرض بالاترین قیمت:** بازه قیمت کاتالوگ به طور پیش‌فرض روی بالاترین سقف قیمت تنظیم شده است تا تمام محصولات به طور کامل در ابتدا نمایش داده شوند.
* **فیلتر پویای قیمت:** کاربر می‌تواند با استفاده از اسلایدر قیمت (از کمترین قیمت تا بالاترین قیمت)، سقف قیمت کارتن محصولات را به دلخواه کاهش داده و فیلتر نماید.
* **اندپوینت فیلتر بازه قیمت:**
\`\`\`http
GET /api/v1/products/list/?min_price=0&max_price=200000000
\`\`\`
